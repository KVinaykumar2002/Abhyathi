...
const FLOATING_ASSETS = [
  {
    id: 1,
    src: "https://images.unsplash.com/photo-1600003263720-95bafb2f12d4?w=500&h=500&fit=crop&q=80",
    top: "20%",
    left: "5%",
    blur: "blur(5px)",
    size: "120px",
  ...
  {
    id: 2,
    src: "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=500&h=500&fit=crop&q=80",
    top: "10%",
    left: "15%",
    blur: "none",
    size: "110px",
  ...
  {
    id: 3,
    src: "https://images.unsplash.com/photo-1615486511484-92e59018c69c?w=600&h=600&fit=crop&q=80",
    top: "35%",
    left: "10%",
    blur: "none",
    size: "160px",
  ...
  {
    id: 4,
    src: "https://images.unsplash.com/photo-1517254797899-04edd251bfb4?w=400&h=400&fit=crop&q=80",
    top: "30%",
    left: "25%",
    blur: "blur(8px)",
    size: "50px",
  ...
  {
    id: 5,
    src: "https://images.unsplash.com/photo-1523362628745-0fef17b55598?w=500&h=500&fit=crop&q=80",
    top: "15%",
    left: "35%",
    blur: "blur(5px)",
    size: "90px",
  ...
  {
    id: 6,
    src: "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?w=700&h=700&fit=crop&q=80",
    top: "0%",
    left: "45%",
    blur: "blur(10px)",
    size: "230px",
  ...
  {
    id: 7,
    src: "https://images.unsplash.com/photo-1530587191329-caadcf215624?w=400&h=400&fit=crop&q=80",
    top: "5%",
    left: "60%",
    blur: "none",
    size: "75px",
  ...
  {
    id: 8,
    src: "https://images.unsplash.com/photo-1562157873-818bc0666a13?w=400&h=400&fit=crop&q=80",
    top: "12%",
    right: "30%",
    blur: "blur(8px)",
    size: "55px",
  ...
  {
    id: 9,
    src: "https://images.unsplash.com/photo-1604719312566-8912e9227c6a?w=600&h=600&fit=crop&q=80",
    top: "5%",
    right: "10%",
    blur: "none",
    size: "180px",
  ...
  {
    id: 11,
    src: "https://images.unsplash.com/photo-1625246333195-78d9c38adbc2?w=400&h=400&fit=crop&q=80",
    top: "30%",
    right: "5%",
    blur: "blur(8px)",
    size: "50px",
...
function FloatingImage({ asset }) {
  const duration = 5 + (asset.id % 10) * 0.35;
  return (
    <motion.img
      src={asset.src}
      alt=""
      className="absolute pointer-events-none select-none hidden md:block rounded-2xl object-cover shadow-lg shadow-black/40 ring-1 ring-white/10"
      style={{
        top: asset.top,
        left: asset.left,
        right: asset.right,
      ...
      animate={{
        y: [0, -15, 0],
        rotate: [asset.rotate, asset.rotate + 5, asset.rotate],
      }}
      transition={{
        duration,
        repeat: Infinity,
