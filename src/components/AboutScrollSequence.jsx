...
/** Scroll-scrub packaging frames; sticky viewport until scrub completes, then page continues below. */
export default function AboutScrollSequence() {
  ...
  const { canvasRef, scrollYProgress, reducedMotion } = useScrollFrameScrub(
    trackRef,
    frameUrls,
    { fit: "cover", offset: ["start start", "end end"] }
  );
  ...
  return (
    <section
      className="relative bg-surface-base [--about-scroll-h:calc(100svh_+_45vh)] md:[--about-scroll-h:calc(100svh_+_55vh)]"
